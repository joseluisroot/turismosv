...
Route::middleware('guest')->group(function () {
    Route::get('/acceso-social/consentimiento', [SocialAuthController::class, 'consent'])->name('social.consent');
    Route::post('/acceso-social/consentimiento', [SocialAuthController::class, 'complete'])->name('social.complete');
});
...
Route::prefix('administracion')->name('admin.')->middleware(['auth', 'verified', 'admin'])->group(function () {
    ...
    Route::get('/lanzamiento', [LaunchController::class, 'index'])->name('launch.index');
    Route::put('/lanzamiento/{item}', [LaunchController::class, 'update'])->name('launch.update');
